    ...
    <main className="site-shell">
      <header className="site-header">
        ...
        <nav className={`site-nav ${menuOpen ? "is-open" : ""}`} aria-label="Main navigation">
          <a href="#shows" onClick={closeMenu}>Shows</a><a href="#about" onClick={closeMenu}>About</a><a href="#contact" onClick={closeMenu}>Contact / Booking</a><a className="social-nav-link" href={instagramUrl} target="_blank" rel="noreferrer" onClick={closeMenu}><InstagramIcon /><span>@dustin.visser</span></a><a className="social-nav-link" href={tourInstagramUrl} target="_blank" rel="noreferrer" onClick={closeMenu}><InstagramIcon /><span>@smalltownbiglaughs</span></a>
        </nav>
      ...
      <footer className="site-footer section-pad"><div className="footer-brand"><a className="site-brand" href="#top"><span className="site-brand-mark">DV</span><span className="site-brand-name">Dustin Visser</span></a><p>Stand-up comedy from Ontario.</p></div><div className="footer-links"><a href="#shows">Shows</a><a href="#about">About</a><a href="#contact">Contact / Booking</a><a href={instagramUrl} target="_blank" rel="noreferrer"><InstagramIcon /> @dustin.visser</a></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Dustin Visser</span><a href={tourInstagramUrl} target="_blank" rel="noreferrer"><InstagramIcon size={14} /> @smalltownbiglaughs</a><a href="/admin" className="admin-link">Show admin</a></div></footer>
    </main>
  );
}
